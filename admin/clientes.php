...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tables Clientes</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                          ...
                          <?php
                            ...
                            while ($row=mysqli_fetch_array($re)){ ?>
                                    <tr >
                                        <td><center><a href="viewcliente.php?view=<?php echo $row['user_id'];?>"><?php echo $row['user_nombre'];?></a></center></td>
                                        ...
                                        <td><center> <a href="../logica/deleteCliente.php?delete=<?php echo $row['user_id'];?>"><span class="text-danger"> <i class="fa fa-trash fa-fw"></i> </span> </a>
                                                    <a href="editClientes.php?view=<?php echo $row['user_id'];?>"><span class="text-info"> <i class="fa fa-edit fa-fw"></i> </span> </a>
                                        </center></td>
                                    </tr>
                             <?php } ?>
                                </tbody>
